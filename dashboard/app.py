...
st.info(
    "💡 **Why DB Chunks > Articles Collected?**  "
    "Each article is split into overlapping 400-character windows (chunks) before being stored "
    "in ChromaDB. A 2000-character article becomes ~6 chunks. This is the RAG chunking step. "
